...
// Bits
#define NRF24L01_CSN_LOW        GPIO_WriteLow(GPIOC,GPIO_PIN_4)
#define NRF24L01_CSN_HIGH       GPIO_WriteHigh(GPIOC,GPIO_PIN_4)
#define NRF24L01_CE_OUT         NOP
#define NRF24L01_CE_LOW         GPIO_WriteLow(GPIOC,GPIO_PIN_3)
#define NRF24L01_CE_HIGH        GPIO_WriteHigh(GPIOC,GPIO_PIN_3)
