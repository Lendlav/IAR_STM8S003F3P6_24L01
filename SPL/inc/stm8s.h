...
#define UART2_CR3_loCL    ((uint8_t)0x01) /*!< Last Bit Clock pulse mask */

#define UART2_CR4_loDIEN  ((uint8_t)0x40) /*!< LIN Break Detection Interrupt Enable mask */
#define UART2_CR4_loDL    ((uint8_t)0x20) /*!< LIN Break Detection Length mask */
#define UART2_CR4_loDF    ((uint8_t)0x10) /*!< LIN Break Detection Flag mask */
...
#define UART3_CR4_loDIEN  ((uint8_t)0x40) /*!< LIN Break Detection Interrupt Enable mask */
#define UART3_CR4_loDL    ((uint8_t)0x20) /*!< LIN Break Detection Length mask */
#define UART3_CR4_loDF    ((uint8_t)0x10) /*!< LIN Break Detection Flag mask */
...
#define UART4_CR3_loCL    ((uint8_t)0x01) /*!< Last Bit Clock pulse mask */

#define UART4_CR4_loDIEN  ((uint8_t)0x40) /*!< LIN Break Detection Interrupt Enable mask */
#define UART4_CR4_loDL    ((uint8_t)0x20) /*!< LIN Break Detection Length mask */
#define UART4_CR4_loDF    ((uint8_t)0x10) /*!< LIN Break Detection Flag mask */
...
#define CAN_DGR_loKM  ((uint8_t)0x01)
